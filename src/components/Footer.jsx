...
export default function Footer() {
  ...
  return (
    <footer style={{
      ...
      <p style={{
        fontSize: '1.75rem', fontWeight: 700, margin: '0 0 1rem 0',
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem' }} role="list" aria-label="Social media links">
        <a href={INFO.links.github} target="_blank" rel="noopener noreferrer"
          aria-label="Visit Raheel Jamal's GitHub profile"
        ...
        <a href={INFO.links.linkedin} target="_blank" rel="noopener noreferrer"
          aria-label="Visit Raheel Jamal's LinkedIn profile"
        ...
        <a href={INFO.links.facebook} target="_blank" rel="noopener noreferrer"
          aria-label="Visit Raheel Jamal's Facebook profile"
        ...
        <a href={INFO.links.instagram} target="_blank" rel="noopener noreferrer"
          aria-label="Visit Raheel Jamal's Instagram profile"
